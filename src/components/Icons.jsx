...
export const FacebookIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <g fill="none">
      ...
      <path
        fill="#fff"
        d="M144.5 217.685v-79.574h26.676l4-31.023h-30.676v-19.805c0-8.978 2.485-15.09 15.325-15.09h16.383v-27.74c-2.833-.379-12.561-1.22-23.883-1.22-23.625 0-39.842 14.433-39.842 40.939v22.916H81v31.023h26.483v79.574h37.017Z"
      />
    </g>
  </svg>
);
...
export const ResearchGateIcon = ({ className, ...rest }) => (
  <svg
    ...
    className={`w-full h-auto ${className}`}
  >
    <rect width={256} height={256} fill="#00D0AF" rx={60} />
    <path
      fill="#FFFFFF"
      d="M135.5 191.5c-10.5-3-16.5-7-26-18-6.5-8-19-27-25.5-36.5l-4.5-7.5h-18v25.5c.75 32.25 0 31.5 14.25 33.75l7.5 .75v3h-60v-3c0-3 .75-3 6.75-4.5 7.5-1.5 10.5-3.75 11.25-10.5.75-3 .75-23.25.75-59.25 0-52.5-.75-54-2.25-57.75-2.25-3.75-5.25-5.25-13.5-6-3-.75-3.75-.75-3.75-3.75v-3l32.25-.75c41.25-.75 48.75 0 60.75 8.25 11.25 7.5 16.5 18 15 32.25-1.5 15.75-12.75 31.5-28.5 37.5-3 1.5-5.25 2.25-5.25 2.25 0 1.5 13.125 21 21 32.25 11.25 15.75 20.25 24 27 27.75 3 1.5 6.75 2.25 7.5 2.25 2.25 0 2.25 .75 2.25 3s-.75 3.75-1.5 3.75c-3.75 1.5-14.25 1.5-19.5 0ZM97.5 131.25c10.5-5.25 16.5-13.5 17.25-26.25.75-9.75-1.5-16.5-7.5-22.5-6.75-7.5-18.75-10.5-36-9l-7.5 .75v29.25c0 27 0 30 .75 30 .75 0 6.75 .75 13.5 0 10.5 0 12.75-.75 18-3ZM166 143.5c-18.75-3-25.5-15-24-45.75 .75-15.75 2.25-22.5 8.25-28.5 5.25-5.25 9.75-6.75 18.75-7.5 9.75-.75 15.75 1.5 21.75 6 3.75 3 6.75 7.5 6.75 9.75 0 .75-2.25 1.5-4.5 3l-4.5 2.25-2.25-2.25c-3.75-4.5-6.75-6.75-10.5-8.25-7.5-2.25-15 1.5-18.75 8.25-2.25 3.75-2.25 4.5-2.25 21.75 0 16.5 0 18.75 2.25 21.75 3 5.25 9 8.25 15.75 7.5 9.75-.75 15-7.5 15-18v-5.25h-7.5v-9.75h27v11.25c0 9-.75 12-2.25 16.5-4.5 11.25-17.25 18-31.5 16.5Z"
    />
  </svg>
);

export const GoogleScholarIcon = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    viewBox="0 0 300 300" // Adjusted viewBox to 256x256 to ensure the entire icon is visible
    {...rest}
    className={`w-full h-auto ${className}`}
  >
    <rect width={300} height={300} fill="#4285F4" rx={60} />
    <path
      fill="#FFFFFF"
      d="M106.5 55.5l-80.25 70.5h51.75c3.75 33.75 30.75 48 58.5 50.25-5.25 13.5-3 20.25 5.25 29.25-32.25 .75-77.25 19.5-77.25 50.25 3 33.75 47.25 40.5 69 40.5 28.5 .75 60.75-14.25 67.5-40.5 3-26.25-7.5-40.5-23.25-53.25-17.25-13.5-21-21-15.75-30 11.25-12.75 26.25-20.25 29.25-38.25 1.5-12.75-1.5-21-4.5-32.25l33.75-28.5v12c-2.25 1.5-3.75 4.5-3.75 6.75v77.25c1.5 9.75 16.5 8.25 17.25 0v-77.25c0-2.25-1.5-5.25-3.75-6v-18.75l12-12zm43.5 105.75c-45.75 7.5-65.25-65.25-28.5-74.25 42-8.25 62.25 64.5 28.5 74.25zm-3.75 55.5c45 9.75 45.75 47.25 7.5 58.5-33 6.75-61.5-3-60.75-22.5 .75-18.75 26.25-36 53.25-36Z"
    />
  </svg>
);
